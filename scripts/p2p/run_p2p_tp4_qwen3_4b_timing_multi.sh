#!/bin/bash
# Slime P2P weight update timing run: Qwen3-4B, 4 train GPUs + 4 infer GPUs, TP=4.
set -ex
...
LOG_FILE="${LOG_ROOT}/slime_p2p_tp4_qwen3_4b_4t4i_${TS}.log"
ERR_FILE="${LOG_ROOT}/slime_p2p_tp4_qwen3_4b_4t4i_${TS}.err"

HF_CKPT="${HF_CKPT:-/data/nfs_87/xky/models/Qwen3-4B}"
REF_LOAD="${REF_LOAD:-/data/nfs_87/xky/models/Qwen3-4B_torch_dist}"
SLIME_SAVE="${SLIME_SAVE:-/data/nfs_87/xky/models/Qwen3-4B_slime_p2p_test}"
